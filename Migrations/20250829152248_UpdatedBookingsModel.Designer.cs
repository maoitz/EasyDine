...
namespace EasyDine.Migrations
{
    ...
    [Migration("20250829152248_UpdatedBookingsModel")]
    partial class UpdatedBookingsModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EasyDine.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            DateBooked = new DateTime(2025, 8, 30, 12, 0, 0, 0, DateTimeKind.Local),
                            DurationMinutes = 120,
                            Status = "Confirmed",
                            TableId = 1,
                            TotalGuests = 2
                        ...
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            DateBooked = new DateTime(2025, 8, 30, 18, 0, 0, 0, DateTimeKind.Local),
                            DurationMinutes = 120,
                            Status = "Pending",
                            TableId = 2,
                            TotalGuests = 4
