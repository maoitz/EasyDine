...
namespace EasyDine.Migrations
{
    ...
    [Migration("20250831172459_InitialCreate2")]
            ...
            modelBuilder.Entity("EasyDine.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            DateBooked = new DateTime(2025, 9, 1, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            DurationMinutes = 120,
                            Status = "Confirmed",
                            TableId = 1,
                            TotalGuests = 2
                        ...
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            DateBooked = new DateTime(2025, 9, 1, 18, 0, 0, 0, DateTimeKind.Unspecified),
                            DurationMinutes = 120,
                            Status = "Pending",
                            TableId = 2,
                            TotalGuests = 4
